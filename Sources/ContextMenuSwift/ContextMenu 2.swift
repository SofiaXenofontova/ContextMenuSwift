...
public struct ContextMenuItemWithId : ContextMenuItem {
    public var title: String
    public var id: Int
...
public protocol ContextMenuDelegate : AnyObject {
    func contextMenuDidSelect(_ contextMenu: ContextMenu, cell: ContextMenuCell, targetedView: UIView, didSelect item: ContextMenuItemWithId, forRowAt index: Int) -> Bool
    func contextMenuDidDeselect(_ contextMenu: ContextMenu, cell: ContextMenuCell, targetedView: UIView, didSelect item: ContextMenuItemWithId, forRowAt index: Int)
...
public struct ContextMenuConstants {
    ...
    public var MenuWidth : CGFloat = 370
    ...
    public var ItemDefaultHeight : CGFloat = 60
...
//    var footerDefaultHeight : CGFloat = 0
    ...
    public var MenuCornerRadius : CGFloat = 40
...
open class ContextMenu: NSObject {
    ...
    open var onItemTap : ((_ index: Int, _ item: ContextMenuItemWithId) -> Bool)?
    open var onViewAppear : ((UIView) -> Void)?
    open var onViewDismiss : ((UIView) -> Void)?
    
    open var items = [ContextMenuItemWithId]()
    
    open var leagueId : Int = 0
